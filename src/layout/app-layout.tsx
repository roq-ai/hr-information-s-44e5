...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'hr-manager', 'employee', 'payroll-administrator', 'accountant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Hr Data', path: '/hr-data', entity: 'hr_data', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
