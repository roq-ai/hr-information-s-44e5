...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345.create': {
    roles: ['business-owner', 'hr-manager', 'employee', 'payroll-administrator', 'accountant'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
  'Employee #67890.create': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'accountant'],
    key: 'employee',
    tenantPath: [],
    userPath: [],
  },
  'Report #111213.create': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'accountant'],
    key: 'report',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'hr-manager', 'employee', 'payroll-administrator', 'accountant'];
