...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'company', 'hr_data.count', 'payroll.count', 'vacation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('hr_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'hr_data',
          header: 'Hr Data',
          accessorKey: 'hr_data',
          cell: ({ row: { original: record } }: any) => record?._count?.hr_data,
        }
      : null,
