...
import { getHrDataById, updateHrDataById } from 'apiSdk/hr-data';
...
function HrDataEditPage() {
  ...
  const handleSubmit = async (values: HrDataInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateHrDataById(id, values);
      mutate(updated);
      resetForm();
      router.push('/hr-data');
    } catch (error: any) {
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.disciplinary_actions}
            label={'Disciplinary Actions'}
            props={{
              name: 'disciplinary_actions',
              placeholder: 'Disciplinary Actions',
              value: formik.values?.disciplinary_actions,
              onChange: formik.handleChange,
            }}
          />

          <TextInput
            error={formik.errors.promotion_status}
